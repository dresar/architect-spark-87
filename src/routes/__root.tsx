  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-lg font-medium text-foreground">Halaman tidak ditemukan</h2>
  ...
  head: () => ({
    meta: [
      ...
      { title: "AI Software Architect" },
      {
        name: "description",
        content:
          "Rancang aplikasi kelas enterprise dari nol — planning, PRD, arsitektur, database, API, dan master prompt untuk AI coding.",
      },
      { name: "author", content: "AI Software Architect" },
      { property: "og:title", content: "AI Software Architect" },
      {
        property: "og:description",
        content:
          "Studio perencanaan aplikasi berbasis AI: dari ide, PRD, arsitektur, hingga master prompt.",
      },
